...
<head>
    ...
    <meta name="msapplication-TileImage" content="{{ url('/template/public') }}/assets/img/metis-tile.png" />

    <!-- Bootstrap -->
    <link rel="stylesheet" href="{{ url('/template/public') }}/assets/lib/bootstrap/css/bootstrap.css">

    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ url('/template/public') }}/assets/lib/font-awesome/css/font-awesome.css">

    <!-- Metis core stylesheet -->
    <link rel="stylesheet" href="{{ url('/template/public') }}/assets/css/main.css">

    <!-- metisMenu stylesheet -->
    <link rel="stylesheet" href="{{ url('/template/public') }}/assets/lib/metismenu/metisMenu.css">

    <!-- onoffcanvas stylesheet -->
    <link rel="stylesheet" href="{{ url('/template/public') }}/assets/lib/onoffcanvas/onoffcanvas.css">

    <!-- animate.css stylesheet -->
    <link rel="stylesheet" href="{{ url('/template/public') }}/assets/lib/animate.css/animate.css">
...
<![endif]-->
    ...
    <link rel="stylesheet" href="{{ url('/template/public') }}/assets/css/style-switcher.css">
    <link rel="stylesheet/less" type="text/css" href="{{ url('/template/public') }}/assets/less/theme.less">
...
<div class="row">
	...
	<div class="box">
		...
		<div id='calendar'></div>
            ...
            <!-- /#helpModal -->
            <!--jQuery -->
            <script src="{{ url('/template/public') }}/assets/lib/jquery/jquery.js"></script>
            ...
            <!--Bootstrap -->
            <script src="{{ url('/template/public') }}/assets/lib/bootstrap/js/bootstrap.js"></script>
            <!-- MetisMenu -->
            <script src="{{ url('/template/public') }}/assets/lib/metismenu/metisMenu.js"></script>
            <!-- onoffcanvas -->
            <script src="{{ url('/template/public') }}/assets/lib/onoffcanvas/onoffcanvas.js"></script>
            <!-- Screenfull -->
            <script src="{{ url('/template/public') }}/assets/lib/screenfull/screenfull.js"></script>


            <!-- Metis core scripts -->
            <script src="{{ url('/template/public') }}/assets/js/core.js"></script>
            <!-- Metis demo scripts -->
            <script src="{{ url('/template/public') }}/assets/js/app.js"></script>
            ...
            <script src="{{ url('/template/public') }}/assets/js/style-switcher.js"></script>
        </body>
