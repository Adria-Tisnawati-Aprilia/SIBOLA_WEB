        ...
        <div class="row">
            <div class="col-md-4">
                <div class="box box-primary">
                    ...
                    <form action="{{ url('/owner/fasilitas') }}" method="POST">
                        @csrf
                        <div class="box-body">
                            <div class="form-group">
                                <label for="fasilitas" class="sr-only"> Fasilitas </label>
                                ...
                                @foreach ($data_fasilitas as $data)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="{{ url('/owner/fasilitas/' . $data->id) }}" method="POST"
    ...
    <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ url('/owner/fasilitas/simpan') }}" method="POST">
                    @method('PUT')
                    @csrf
